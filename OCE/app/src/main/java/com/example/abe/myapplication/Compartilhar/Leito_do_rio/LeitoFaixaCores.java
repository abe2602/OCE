...
/*
 * Classe de compartilhamento referente à faixa de cores
...
public class LeitoFaixaCores extends AppCompatActivity {
    ...
    public void OnClickVermelho(View view) {
        this.sendRelato("Faixa no Vermelho", this.tipo);
    }

    public void OnClickAmarelo(View view) {
        this.sendRelato("Faixa no Amarelo", this.tipo);
    }

    public void OnClickVerde(View view) {
        this.sendRelato("Faixa no Verde", this.tipo);
    }
